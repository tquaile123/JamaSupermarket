...
/**
 * The BaseProduct class represents the base product sold in the Supermarket
...
public abstract class BaseProduct {
     ...
     */
    public BaseProduct(Character name, Integer price) {
        this.setName(name);
        this.setPrice(price);
    }
     ...
     */
    public BaseProduct(Character name, Integer price, Integer numberForSpecial, Integer specialMultiplier) {
        this.setName(name);
        this.setPrice(price);
